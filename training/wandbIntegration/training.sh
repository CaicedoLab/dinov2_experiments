...
torchrun --nproc_per_node=1 ./dinov2/train/train.py --config-file=./dinov2/configs/train/config.yaml --output-dir=./output train.dataset_path=ImageNet:split=TRAIN:root=$jobDir/imagenet/train:extra=$jobDir/extra & 
